...
- **[面试全集：life-video-mvp](./docs/面试全集-life-video-mvp.md)** — ⭐ 项目介绍、五个故事、话术、简历（面试前读这份）
- **[面试话术与概念速查](./docs/面试话术与概念速查.md)** — E2E 详解、分题型短答
- **[全栈学习笔记：前端转全链路](./docs/全栈学习笔记-前端转全链路.md)** — 心智模型、排查、AI 验收
